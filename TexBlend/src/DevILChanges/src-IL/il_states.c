...
ILboolean ilAble(ILenum Mode, ILboolean Flag)
{
	switch (Mode)
	{
		...
		case IL_SQUISH_COMPRESS:
			...
			break;
		case IL_USE_PREMULTALPHA:
			ilStates[ilCurrentPos].ilUsePremultAlpha = Flag;
			break;
		case IL_BMP_MATTEALPHA:
			ilStates[ilCurrentPos].ilMattAlpha = Flag;
			break;
		case IL_BMP_MATTEALPHAB:
			ilStates[ilCurrentPos].ilMattAlphaB = Flag;
			break;
		default:
			ilSetError(IL_INVALID_ENUM);
			return IL_FALSE;
...
ILboolean ILAPIENTRY ilIsEnabled(ILenum Mode)
{
	switch (Mode)
	{
		...
		case IL_USE_PREMULTALPHA:
			return ilStates[ilCurrentPos].ilUsePremultAlpha;
		case IL_BMP_MATTEALPHA:
			return ilStates[ilCurrentPos].ilMattAlpha;
		case IL_BMP_MATTEALPHAB:
			return ilStates[ilCurrentPos].ilMattAlphaB;
		default:
			ilSetError(IL_INVALID_ENUM);
	}
